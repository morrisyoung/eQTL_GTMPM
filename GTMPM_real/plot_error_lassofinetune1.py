...
if __name__=="__main__":
	...
	#color = map_color[R]
	color = "r"
	plt.plot(list_error_test[:], color=color, ls=ls, label="R=" + R)
	##
	model = "ml"
	R = "0.9"
	list_error_test = np.load("./result_lasso_finetune/list_error_test_" + model + "_R" + R + ".npy")
	...
	list_error_test = np.load("./result_lasso_finetune/list_error_test_" + model + "_R" + R + ".npy")
	list_error_test = 1 - list_error_test / ve_test
	plt.plot(list_error_test[:], color='r', ls=ls, label="R=" + R)
	##
	model = "nn"
	R = "0.03"
	list_error_test = np.load("./result_lasso_finetune/list_error_test_" + model + "_R" + R + ".npy")
	list_error_test = 1 - list_error_test / ve_test
	plt.plot(list_error_test[:], color='y', ls=ls, label="R=" + R)
	##
	model = "nn"
	R = "0.04"
	list_error_test = np.load("./result_lasso_finetune/list_error_test_" + model + "_R" + R + ".npy")
	list_error_test = 1 - list_error_test / ve_test
	plt.plot(list_error_test[:], color='g', ls=ls, label="R=" + R)
	##
	model = "nn"
	R = "0.05"
	list_error_test = np.load("./result_lasso_finetune/list_error_test_" + model + "_R" + R + ".npy")
	list_error_test = 1 - list_error_test / ve_test
	plt.plot(list_error_test[:], color='c', ls=ls, label="R=" + R)
	##
	model = "nn"
	R = "0.06"
	list_error_test = np.load("./result_lasso_finetune/list_error_test_" + model + "_R" + R + ".npy")
	list_error_test = 1 - list_error_test / ve_test
	plt.plot(list_error_test[:], color='m', ls=ls, label="R=" + R)
