...
if __name__ == "__main__":
	...
	np.save("./ml_data_real_init/beta2_init", init_beta2)
	...
	## m_factor to be used
	np.save("./ml_data_temp/m_factor", m_factor)
	...
	np.save("./ml_data_temp/m_indi", m_indi)
	...
	np.save("./ml_data_temp/m_indi_snp", m_indi_snp)
