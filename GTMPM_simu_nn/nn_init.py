...
if __name__ == "__main__":
	...
	## load data
	X = np.load("./data_simu_nn/X_train.npy")
	Y = np.load("./data_simu_nn/Y_train.npy")
	...
	##==== save the init
	##=====================================================================================================================
	np.save("./data_simu_nn/beta1_init_nn", init_beta1)
	np.save("./data_simu_nn/beta2_init_nn", init_beta2)
