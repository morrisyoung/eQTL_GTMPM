...
## nn LASSO
#beta1_init = np.load("./data_simu_nn/beta1_init.npy")
#beta2_init = np.load("./data_simu_nn/beta2_init.npy")
#
beta1_init = np.load("./data_simu_nn/beta1_init_nn.npy")
beta2_init = np.load("./data_simu_nn/beta2_init_nn.npy")
...
with tf.device("/cpu:0"):
	...
	##
	#lr = tf.constant(0.001, name='learning_rate')						## good for nn random init
	lr = tf.constant(0.0001, name='learning_rate')						## good for nn sparse init
