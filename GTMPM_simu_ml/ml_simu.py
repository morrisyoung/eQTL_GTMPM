...
if __name__ == "__main__":
	...
	np.save("./data_simu_ml_largeN/Y_train_index", list_index)
	# test
	K = len(Y_test)
	N = len(Y_test[0])
	J = len(Y_test[0][0])
	...
	np.save("./data_simu_ml_largeN/Y_test_index", list_index)
	...
	##==== save data
	np.save("./data_simu_ml_largeN/X", X)
	np.save("./data_simu_ml_largeN/X_train", X_train)
	np.save("./data_simu_ml_largeN/X_test", X_test)
	np.save("./data_simu_ml_largeN/Y", Y)
	np.save("./data_simu_ml_largeN/Y_spread", Y_spread)
	np.save("./data_simu_ml_largeN/Y_train", Y_train)
	np.save("./data_simu_ml_largeN/Y_train_spread", Y_train_spread)
	np.save("./data_simu_ml_largeN/Y_test", Y_test)
	np.save("./data_simu_ml_largeN/Y_test_spread", Y_test_spread)
	np.save("./data_simu_ml_largeN/beta1_real", beta1)
	np.save("./data_simu_ml_largeN/beta2_real", beta2)
	...
	print "beta2 shape:", beta2.shape
	##
	np.save("./data_simu_ml_largeN/beta1_init", beta1)
	np.save("./data_simu_ml_largeN/beta2_init", beta2)
