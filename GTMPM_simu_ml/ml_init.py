...
if __name__ == "__main__":
	...
	clf = linear_model.Lasso(alpha=0.0001)									## TODO: tune the strength
	clf.fit(Data, Target)
	#clf.coef_									# (n_tasks, n_features)
	#clf.intercept_								# (n_tasks,)
	intercept = (np.array([clf.intercept_])).T
	...
	##==== save the init
	##=====================================================================================================================
	np.save("./data_simu_ml_largeN/beta1_init_wise", init_beta1)
	np.save("./data_simu_ml_largeN/beta2_init_wise", init_beta2)
