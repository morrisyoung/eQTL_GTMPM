...
# data_simu_ml -> data_simu_ml_realN
...
## load model
#beta1_init = np.load("./data_simu_ml_realN/beta1_init.npy")
#beta2_init = np.load("./data_simu_ml_realN/beta2_init.npy")
##
beta1_init = np.load(header + "beta1_init_wise.npy")
beta2_init = np.load(header + "beta2_init_wise.npy")
...
with tf.device("/cpu:0"):
	...
	## realN
	#lr = tf.constant(0.0000000000008, name='learning_rate')				## good for ml random init



	## test different rates:
	#lr = tf.constant(0.00000000002, name='learning_rate')					## good for ml LASSO init, but test set has a little fluctuation
	#lr = tf.constant(0.00000000001, name='learning_rate')					## good for ml LASSO init, but slow?
	lr = tf.constant(0.000000000015, name='learning_rate')
	...
	## largeN
	#lr = tf.constant(0.000000000003, name='learning_rate')					## good for lasso init, but small


	#lr = tf.constant(0.00000000000008, name='learning_rate')					## good for random init, but init error quite large
